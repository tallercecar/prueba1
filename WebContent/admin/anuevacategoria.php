...
<div class="">
	<div  class="row">
				...
				<td>
							<form >
								...
								<label for="nombre">NOMBRE CATEGORÍA</label>
									...
									<a class="waves-effect waves-teal btn-flat tooltipped" data-position="bottom" data-tooltip="Guardar Categoría."><i class="material-icons">save</i>Guardar</a>
		...
		<!-- Fin tabla interna con categorías -->
		</div>
	</div>		
</div>
